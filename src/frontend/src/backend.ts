...
export class Backend implements backendInterface {
    ...
    async addCustomer(arg0: string, arg1: Address, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: bigint, arg1: Measurements, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateOrder(arg0: bigint, arg1: Measurements, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrder(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
